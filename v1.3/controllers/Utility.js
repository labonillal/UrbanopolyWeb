    ...
    if(type == 'success'){
        ...
        switch(code) {
            ...
            case 4:
                //Pay venue
                message.code = code;
                message.text = 'You paid the fee. The fee has been payed for the venue.';
                break;
            case 5:
                //Take venue
                message.code = code;
                message.text = 'You took the venue!. Would you like to share the purchasing on facebook?.';
                break;
            case 6:
                //Advertise venue
                message.code = code;
                message.text = 'Advertise session finished!. You earned ' + venueName + ' €.';
                break;
            case 7:
                //Quiz venue
                message.code = code;

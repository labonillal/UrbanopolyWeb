...
// Retrieves visits corresponding to the venue of type JUDGE and not sent
exports.getVisitJudge = function(venue){
	for(var i = 0; i < inVisits.length; i++){
		if(inVisits[i].venue == venue.id && inVisits[i].type == 'JUDGE' && inVisits[i].sent != true){
			return inVisits[i];
		}
	}
	return null;

...
// ROUTES - ScreenInfo (@return - JSON)
app.get('/retrieveMap', mapController.getMapData);
app.get('/retrieveChildCategories', pageController.getChildCategories);
app.get('/retrieveCategory', pageController.getCategoryById);
app.get('/retrieveVenueRent', pageController.getVenueRent);
app.get('/retrieveTakeCost', pageController.getTakeCost);
app.get('/retrieveVenueDetails', pageController.getVenueDetails);
app.get('/retrieveAlreadyVisitedVenues', pageController.getPlayerAlreadyVisited);

// ROUTES - Game Actions (@return - JSON)
app.post('/BuyAction', pageController.getBuyAction);
app.post('/SellAction', pageController.getSellAction);
app.post('/MortgageAction', pageController.getMortgageAction);
app.post('/RedeemAction', pageController.getRedeemAction);
app.post('/PayAction', pageController.getPayAction);
app.post('/TakeAction', pageController.getTakeAction);
...
app.post('/JudgeAction', pageController.getJudgeAction);
app.post('/Share', pageController.getShare);
app.post('/Upload', pageController.getUploadAction);
